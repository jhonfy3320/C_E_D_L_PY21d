"""
Código utilizado durante la clase 'Operaciones esenciales en colecciones'
Demostración de métodos comunes para estructuras de datos.
"""

# Creando lista con diferentes elementos

"""
Code used during the class 'Operatives essential's en colecciones'
